...
const MAKES: { make: string; models: string[] }[] = [
  {
    ...
    models: [
      ...
      "Corolla 2.0 XR CVT",
      "Corolla Cross", "Corolla Cross 1.8 XS CVT", "Corolla Cross 1.8 Hybrid XS",
      "Corolla Quest", "Corolla Quest 1.8", "Corolla Quest 1.8 Prestige",
      "RAV4", "RAV4 2.0 GX CVT", "RAV4 2.0 GX-R", "RAV4 2.5 Hybrid XS",
      "Land Cruiser", "Land Cruiser 70", "Land Cruiser 76", "Land Cruiser 78",
      "Land Cruiser 79", "Land Cruiser 80", "Land Cruiser 100",
      ...
      "Starlet", "Starlet 1.4 Xi", "Starlet 1.4 Xs MT", "Starlet Cross",
      "Urban Cruiser", "Urban Cruiser 1.5 XS CVT",
      "GR Yaris", "GR 86", "GR Supra",
      "C-HR", "FJ Cruiser", "Prius", "BZ4X",
      "Agya", "Innova", "Rumion", "Rush",
      "Avensis", "Auris", "Camry", "Cressida", "Crown",
      "Conquest", "RunX", "Tazz", "Verso",
      "Quantum", "Coaster", "Dyna",
    ],
  },
  {
    make: "Volkswagen",
    models: [
      ...
      "T-Cross", "T-Cross 1.0 TSI Comfortline", "T-Cross 1.5 TSI R-Line",
      "T-Roc", "T-Roc 1.4 TSI Design", "T-Roc 2.0 TSI R-Line",
      "Taigo", "Tayron",
      "Touareg", "Touareg 3.0 TDI V6 Executive",
      "Caddy", "Caddy 2.0 TDI Panel Van", "Caddy Pick-Up",
      "Transporter", "Transporter 2.0 TDI Panel Van",
      "Caravelle", "Kombi",
      "Passat", "Passat 2.0 TDI Elegance",
      "Jetta", "Up", "Citi",
      "Arteon", "CC", "Touran", "Scirocco", "Beetle",
      "California", "Westfalia",
      "Crafter", "Eos", "Fox",
    ],
  },
  {
    ...
    models: [
      ...
      "7 Series", "7 Series 740i", "7 Series 750i xDrive",
      ...
      "X3 xDrive30i", "X3 xDrive30d", "X3 M40i",
      ...
      "X7", "X7 xDrive30d", "X7 xDrive40i",
      "M2 Competition", "M3", "M3 Competition", "M4", "M4 Competition",
      "M5 Competition",
    ],
  },
  {
  ...
  },
  {
    ...
    models: [
      ...
      "Fiesta", "Fiesta 1.0 EcoBoost Titanium", "Fiesta 1.6 TDCi Titanium",
      "Figo",
      "Focus", "Focus 1.5 EcoBoost ST-Line", "Focus 2.3 ST",
      "EcoSport", "EcoSport 1.0 EcoBoost Titanium", "EcoSport 1.5 TDCi Titanium",
      "Territory", "Territory 1.5 EcoBoost Trend", "Territory 1.5 EcoBoost Titanium",
      "Mustang", "Mustang 2.3 EcoBoost", "Mustang 5.0 V8 GT",
      "Puma", "Kuga",
      "Tourneo Custom", "Transit Custom",
      "Transit", "Tourneo Connect", "Transit Connect",
      "Bantam", "Fusion", "Ka", "Ikon",
      "F250", "F100",
    ],
  },
  {
    ...
    models: [
      ...
      "i30", "i30 1.4 T-GDI Elite", "i30 N 2.0 T-GDI",
      "i10", "Grand i10", "Grand i10 1.0 Motion", "Grand i10 1.2 Fluid",
      ...
      "ix35", "ix35 2.0 Premium", "ix35 2.0 GLS",
      "Santa Fe", "Santa Fe 2.2 CRDi Elite AWD", "Santa Fe 2.2 CRDi Premium AWD",
      "Elantra", "Elantra 1.5 MPI Executive IVT", "Elantra N 2.0 T-GDI",
      "Venue", "Venue 1.0 T-GDI Motion DCT", "Venue 1.0 T-GDI Fluid DCT",
      "Staria", "Staria 2.2 CRDi Executive",
      "Palisade", "Palisade 2.2d Elite AWD",
      "Kona", "Alcazar", "Exter",
      "H-1", "H-1 2.5 CRDi Wagon",
      "H100 Bakkie",
      "Accent", "Atos", "Getz",
      "Sonata", "Veloster",
    ],
  },
  {
    ...
    models: [
      ...
      "Seltos", "Seltos 1.5 EX IVT", "Seltos 1.4 T-GDI EX DCT",
      "Sonet", "Sonet 1.0 T-GDI EX DCT", "Sonet 1.5 EX IVT",
      "Cerato", "Cerato 1.6 EX", "Cerato 2.0 EX",
      "Picanto", "Picanto 1.0 LX", "Picanto 1.2 EX",
      "Pegas", "Pegas 1.4 EX",
      "Rio",
      "Stinger", "Stinger 2.0 T-GDI GT-Line", "Stinger 3.3 T-GDI GT",
      "Sorento", "Sorento 2.2 CRDi EX AWD", "Sorento 1.6 T-GDI Hybrid",
      "Carnival", "Carnival 2.2 CRDi SXL",
      "Tasman",
      "Soul", "Sedona", "Carens", "Optima",
      "Magentis", "K-Series Pick-Up",
    ],
  },
  {
    make: "Audi",
    models: [
      ...
      "A4 35 TDI Advanced",
      "S4", "S4 3.0 TFSI", "RS4",
      "A5", "A5 2.0 TFSI Sport S tronic", "A5 40 TFSI S line",
      "S5", "S5 3.0 TFSI", "RS5",
      "A6", "A6 40 TDI S tronic", "A6 45 TFSI S tronic",
      "S6", "RS6", "RS6 4.0 TFSI Avant",
      "A7", "S7", "RS7",
      "A8", "S8",
  ...
  },
  {
    make: "Nissan",
    models: [
      "NP200", "NP300 Hardbody", "NP300 Hardbody 2.5 TDI 4x4", "NP300 Hardbody 2.5 TDI LE",
      ...
      "Magnite", "Magnite 1.0 Turbo Acenta", "Magnite 1.0 Turbo Tekna",
      "Micra", "Micra 1.0 Acenta",
      "Juke", "Murano",
      "Hardbody", "Tiida", "370Z",
      "Almera", "Patrol",
    ],
  },
  {
    ...
    models: [
      ...
      "CX-60", "CX-60 3.3D Homura AWD",
      "BT-50", "BT-50 3.0 TDCi Active 4x4", "BT-50 3.0 TDCi Thunder 4x4",
      "RX-8", "Mazda5", "Mazda6",
    ],
  },
  {
    ...
    models: [
      ...
      "BR-V", "Elevate", "Elevate 1.5 Comfort CVT",
      "Accord", "Brio", "Fit", "Mobilio",
      "S2000", "Prelude", "FR-V", "CR-Z",
    ],
  },
  {
    make: "Suzuki",
    models: [
      ...
      "Vitara", "Vitara 1.4 Boosterjet GL AllGrip",
      "Grand Vitara", "Grand Vitara 1.5 GL AllGrip",
      "Vitara Brezza",
      "Baleno", "Baleno 1.5 GL CVT", "Baleno 1.5 GLX CVT",
      "Ertiga", "Ertiga 1.5 GL CVT", "Ertiga 1.5 GLX CVT",
      "S-Presso", "S-Presso 1.0 GL", "S-Presso 1.0 GLX AMT",
      "Fronx", "Fronx 1.5 GL CVT", "Fronx 1.0 Boosterjet GLX",
      "Dzire",
      "XL6", "Ignis", "Celerio", "Across",
      "Super Carry", "SX4", "Alto", "Kizashi",
    ],
  },
  {
    make: "Renault",
    models: [
      ...
      "Triber", "Triber 1.0 Dynamique", "Triber 1.0 Intens AMT",
      "Kiger", "Kiger 1.0 Turbo Zen", "Kiger 1.0 Turbo Intens CVT",
      "Koleos", "Koleos 2.0 dCi Intens 4WD",
      "Kadjar", "Megane",
      "Trafic", "Kangoo",
      "Scenic", "Fluence", "Laguna", "Logan", "Modus", "Espace", "Twingo",
    ],
  },
  {
    make: "Isuzu",
  ...
  },
  {
    make: "GWM",
    models: [
      "P-Series", "P-Series 2.0TD LT 4x4", "P-Series 2.0TD Ultra 4x4",
      "P500",
      "Tank 300", "Tank 500",
      "Steed 5", "Steed 5E", "Steed 6", "Steed 6 2.0 VGT SX 4x4",
      "Ora",
      "C10",
      "H5", "H6",
      "Hover", "Florid",
  ...
  },
  {
    ...
    models: [
      ...
      "Defender 90", "Defender 90 P300 SE",
      "Defender 110", "Defender 110 P300 SE", "Defender 110 3.0D SE",
      "Defender 130",
      "Freelander",
  ...
  },
  {
    ...
    models: [
      ...
      "Outlander", "Outlander 2.0 GLS", "Outlander 2.4 MIVEC GLS AWD",
      "Eclipse Cross", "Eclipse Cross 1.5T GLS", "Eclipse Cross 2.2D 4WD",
      "Triton", "Triton 2.4D 4WD Club Cab",
      "ASX", "ASX 2.0 GLS CVT",
      "Xpander",
      "Destinator",
    ],
  },
  {
    ...
    models: [
      ...
      "Cherokee", "Cherokee 2.0T Longitude Plus",
      "Compass", "Compass 1.3T Longitude Plus DCT",
      "Renegade", "Renegade 1.3T Longitude DCT",
      "Gladiator",
      "Patriot",
    ],
  },
  {
    ...
    models: [
      ...
      "EX30", "EX90", "ES90",
      "S60", "V60", "S60 T5 Momentum", "V60 T5 Momentum",
      "S40", "V40", "V50",
      "S80", "S90", "V90",
      "C30", "C70",
    ],
  },
  {
    make: "Subaru",
    models: [
      "Forester", "Forester 2.0i-S e-Boxer", "Forester 2.0i-L",
      "Outback", "Outback 2.5 Premium CVT", "Outback 2.5 Sport CVT",
      "XV", "XV 2.0i Premium CVT", "XV 1.6i Premium",
      "Crosstrek",
      "Impreza", "Impreza 2.0i Premium CVT",
      "WRX", "WRX 2.4 Sport CVT",
      "WRX STI", "WRX STI 2.5",
      "Legacy",
    ],
  },
  {
    make: "Porsche",
    models: [
      "911", "911 Carrera", "911 Carrera S", "911 Carrera 4S", "911 Turbo S", "911 GT3",
      "Cayenne", "Cayenne 3.0 TDI", "Cayenne Coupe S", "Cayenne Turbo",
      "Macan", "Macan S", "Macan GTS",
      "Panamera", "Panamera 4S", "Panamera Turbo S",
      "Boxster", "718 Boxster",
      "Cayman", "718 Cayman", "718 Spyder",
      "Taycan", "Taycan 4S", "Taycan Turbo",
    ],
  },
  {
    make: "MINI",
    models: [
      "Hatch",
      "Cooper", "Cooper 1.5 Classic", "Cooper S 2.0 Sport", "Cooper S Works 2.0",
      "Countryman", "Countryman Cooper D", "Countryman Cooper S", "Countryman JCW 2.0",
      "Clubman", "Clubman Cooper S All4",
      "Convertible", "Convertible Cooper S 2.0",
      "Paceman", "Roadster",
    ],
  },
  {
    make: "Peugeot",
    models: [
      "208", "208 1.2 PureTech Active", "208 1.2 PureTech Allure",
      "2008", "2008 1.2 PureTech Active", "2008 1.2 PureTech Allure",
      "308", "308 1.6 THP GTi",
      "3008", "3008 1.6 THP GT Line",
      "508", "508 2.0 BlueHDi GT",
      "5008",
      "107", "108",
      "206", "207",
      "307", "407",
      "Landtrek", "Landtrek 1.9D 4x4",
      "RCZ",
      "Boxer", "Partner",
    ],
  },
  {
    ...
    models: [
      ...
      "Corsa Utility",
      "Astra", "Astra 1.4T Sport", "Astra 1.6T OPC",
      "Mokka", "Mokka 1.2T Enjoy", "Mokka 1.2T Edition",
      "Mokka X",
      "Crossland", "Crossland 1.2T Enjoy",
      "Crossland X",
      "Grandland X", "Grandland 1.2T Enjoy",
      "Adam",
      "Zafira", "Meriva", "Combo", "Vivaro",
      "Kadett", "Monza", "Rekord",
    ],
  },
  {
    ...
    models: [
      "Tiggo", "Tiggo Cross",
      "Tiggo 4 Pro", "Tiggo 4 1.5T Executive DCT", "Tiggo 4 1.5T Comfort",
      "Tiggo 7 Pro", "Tiggo 7 1.5T Executive DCT", "Tiggo 7 Pro 1.6T Executive DCT",
      "Tiggo 8 Pro", "Tiggo 8 Pro 1.6T Executive",
      "Tiggo 9",
    ],
  },
  {
  ...
  },
  {
    ...
    models: [
      ...
      "MG HS", "MG HS 1.5T Excite DCT", "MG HS 1.5T Essence DCT",
      "MG ZS", "MG ZS 1.5 Excite CVT", "MG ZS EV Excite", "MG ZS EV Essence",
      "MG4", "MG4 EV Excite", "MG4 EV Essence",
      "MG5", "MG5 Excite CVT",
    ],
  },
  {
  ...
  },
  {
    make: "Lexus",
    models: [
      "IS", "IS 300h", "IS 350 F Sport",
      "ES", "ES 300h Luxury", "ES 350 Luxury",
      "NX", "NX 300h Luxury", "NX 350h F Sport",
  ...
  },
  {
    make: "Alfa Romeo",
    models: [
      "Giulia", "Giulia 2.0T Super", "Giulia 2.9 V6 Quadrifoglio",
      "Stelvio", "Stelvio 2.0T Super AWD", "Stelvio 2.9 V6 Quadrifoglio AWD",
      "Tonale", "Tonale 1.5T MHEV Sprint",
      "Giulietta", "Junior",
      "Spider", "4C", "MiTo",
      "159", "147", "GT", "GTV",
    ],
  },
  {
    make: "Fiat",
    models: [
      "500", "Fiat 500 1.2 Lounge", "Fiat 500 1.4 Abarth",
      "500X", "Fiat 500X 1.4T Cross Plus AWD",
      "500L",
      "Tipo", "Tipo 1.4 Pop", "Tipo 1.6 Lounge",
      "Panda", "Panda 1.2 Easy",
      "Palio", "Uno", "Punto", "Grande Punto",
      "Fullback",
      "Doblo", "Ducato", "Fiorino", "Qubo", "Linea", "Strada",
    ],
  },
  {
    make: "Jaguar",
    models: [
      "XE", "XE 2.0D Pure", "XE 2.0T R-Dynamic",
      "XF", "XF 2.0D Pure", "XF 2.0T R-Dynamic",
      "XJ", "XJ 3.0 V6 Premium Luxury",
      "F-Pace", "F-Pace 2.0D Pure", "F-Pace 3.0D S AWD",
      "E-Pace", "E-Pace 2.0D SE", "E-Pace P250 R-Dynamic",
      "F-Type", "F-Type 2.0T Coupe", "F-Type 5.0 V8 SVR",
  ...
  },
  {
    make: "Citroën",
    models: [
      "C3", "C3 1.2 PureTech Feel", "C3 1.2 PureTech Shine",
      "C4", "C4 1.2 PureTech Feel", "C4 e-C4 Electric",
      "C5 Aircross", "C5 Aircross 1.6T Feel",
      "Basalt",
      "Berlingo", "Jumpy", "Dispatch",
    ],
  },
  {
    make: "Mahindra",
    models: [
      "Pik Up", "Pik Up 2.2 mHawk S10", "Pik Up 2.2 mHawk S11 4x4",
      "Scorpio", "Scorpio N", "Scorpio 2.2 mHawk S11",
      "XUV 300", "XUV300 1.2T W8",
      "XUV 3XO",
      "XUV 500", "XUV 700",
      "KUV 100",
      "Thar", "Thar 2.2 mHawk 4x4",
      "Bolero", "TUV 300",
      "Xylo", "Genio",
    ],
  },
  {
    make: "Ssangyong",
    models: [
      "Rexton", "Rexton 2.2 4WD SX", "Rexton 2.2 4WD Luxury",
      "Musso", "Musso 2.2 Luxury 4x4",
      "Korando", "Korando 1.5T Quartz",
      "Tivoli", "Tivoli 1.5T Quartz",
    ],
  },
  {
    make: "Omoda",
    models: [
      "C5", "C5 1.6T Executive DCT", "C5 EV",
      "C7", "C9",
    ],
  },
  {
  ...
  },
  {
    ...
    models: [
      "EMKOO",
      "GS3 Emzoom",
      "GS3", "GS3 1.5T Comfort", "GS3 1.5T Sport",
      "GS4", "GS4 1.5T Comfort",
      "M8",
    ],
  },
  {
    make: "Chevrolet",
    models: [
      "Spark", "Spark 1.2 LS", "Spark 1.2 LT",
      "Sonic", "Cruze", "Cruze 1.4T LS",
      "Utility",
      "Captiva", "Captiva 2.4 LS", "Captiva 2.2D LT AWD",
      "Trailblazer", "Trailblazer 2.8D LT 4x4",
      "Lumina",
    ],
  },
  {
    make: "Seat",
    models: [
      "Ibiza", "Ibiza 1.0 TSI Style", "Ibiza 1.6 TDI FR",
      "Leon", "Leon 1.4 TSI FR", "Leon 2.0 TSI Cupra",
      "Ateca", "Ateca 1.4 TSI Style", "Ateca 2.0 TDI FR 4Drive",
    ],
  },
  {
    make: "Dodge",
    models: [
      "Challenger", "Challenger 5.7 V8 RT", "Challenger 6.4 V8 Scat Pack", "Challenger 6.2 SRT Hellcat",
      "Charger", "Charger 5.7 V8 RT", "Charger 6.4 V8 Scat Pack",
      "Durango", "Durango 5.7 V8 RT AWD",
    ],
  },
  {
    make: "RAM",
    models: [
      "1500", "1500 5.7 V8 Laramie Crew Cab",
      "1500 TRX", "1500 TRX 6.2 V8",
    ],
  },
  {
    make: "Infiniti",
